-- Harden private profile access and trade-offer mutations.
...
for each row
execute function public.validate_trade_offer_insert();
...
for each row
execute function public.validate_trade_offer_update();
...
revoke execute
on function public.validate_trade_offer_insert()
from public;

revoke execute
on function public.validate_trade_offer_update()
from public;
